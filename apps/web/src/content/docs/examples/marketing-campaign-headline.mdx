...
<ConnectionGraph
	label="Four artifact-sets. {brief} connects to {messaging}. {messaging} connects to {ads} and {landing page}, and {ads} also connects to {landing page}."
	nodes={[
	...
	edges={[["brief", "messaging"], ["messaging", "ads"], ["messaging", "landing"], ["ads", "landing"]]}
/>
